...
## 2026-09-15 優化建議缺口稽核後新增任務

以下只列 GitHub 尚未完整涵蓋的部分；潮汐尾／核心分離、低質量質光關係、
初始質量分層及既有質量相依雙星工作不重複新增。逐項對照見
`docs/planning/M45_OPTIMIZATION_GAP_AUDIT_2026-09-15.md`。
...
membership_probability_weighted_imf：Codex 於本分支認領。先只做現有資料的
