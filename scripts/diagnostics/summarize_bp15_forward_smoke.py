...
def main() -> None:
    ...
    pairs = []
    for seed, suffix in [(2000, ""), (2013, "_rep1")]:
    ...
    output = {
        ...
        "settings": {"n_synthetic": 3000, "paired_seeds": [2000, 2013],
        ...
        "interpretation": [
            "The alpha delta changed sign (-0.067 then +0.267), so these runs cannot establish a BP15 effect.",
